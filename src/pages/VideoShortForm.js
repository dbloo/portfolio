...
const VideoShortForm = ({category, images}) => {
  ...
  return (
    <div style={{marginTop: "13vh"}}>
      ...
      <div className = "text-container">
        <h1 className = "text-page-top">Short Form Videos</h1>
        <h3 className = "text-page-top-2">For the TL</h3>
      </div>
